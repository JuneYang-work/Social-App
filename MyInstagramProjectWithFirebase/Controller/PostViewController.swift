...
//
//  Created by June Yang on 5/29/18.
//  Copyright © 2018 June Yang. All rights reserved.
//
...
class PostViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let postdetail = PostDetail(description: "", imageRef: "", like: 0, timestamp: NSDate().timeIntervalSince1970, userId: "", postImage: nil, postUserImage: nil, name: nil, isLike : false, likeby : ["nil" : "nil"], commentby : [:])
